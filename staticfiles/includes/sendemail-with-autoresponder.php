...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['form_name'] != '' AND $_POST['form_email'] != '' AND $_POST['form_subject'] != '' ) {
        ...
        $toemail = 'info@3gundedis.com'; // Your Email Address
        $toname = '3 Günde İmplant Diş'; // Your Name
		...
		if( $botcheck == '' ) {
			...
			$ar_body = "Thank you for contacting us. We will reply within 24 hours.<br><br>Regards,<br>3GündeDiş.";
